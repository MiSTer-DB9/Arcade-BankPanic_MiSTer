...
UPSTREAM_REPO="https://github.com/MiSTer-devel/Arcade-BankPanic_MiSTer.git"
CORE_NAME=(Arcade-BankPanic)
...
UPSTREAM_CORE_NAME=(Arcade-BankPanic)
MAIN_BRANCH="master"
UPSTREAM_BRANCH="master"
COMPILATION_INPUT=(Arcade-BankPanic.qpf)
COMPILATION_OUTPUT=(output_files/Arcade-BankPanic.rbf)
